...
public class GoHealthAssignmentApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        while (!repoSelected) {
            ...
            System.out.println("(" + REPOSITORY.SQL + ", " + REPOSITORY.CSV + ", " + APPLICATION.EXIT + ")");
        ...
        while (true) {
            ...
            System.out.println("(" + OPERATION.CREATE + ", " + OPERATION.CLOSE + ", " + OPERATION.LIST + ", " + APPLICATION.EXIT + ")");
            ...
            switch (command) {
                case OPERATION.CREATE -> {
                    ...
                    while (!validParent) {
                        ...
                        if (parentIdInput.isBlank())
                            ...
                            if (controller.validateIssue(parentIdInput, RepositoryType.valueOf(repository.toUpperCase())))
                                validParent = true;
                            else {
                    ...
                    System.out.println(
                            controller.processCommand(CreateCommandDto.builder()
                ...
                case OPERATION.CLOSE -> {
                    ...
                    while (!validIssue) {
                        ...
                        if (controller.validateIssue(issueIdInput, RepositoryType.valueOf(repository.toUpperCase())))
                            validIssue = true;
                        else {
                    ...
                    Boolean result = (Boolean) controller.processCommand(CloseCommandDto.builder()
                            .id(issueIdInput)
                ...
                case OPERATION.LIST -> {
                    controller.processCommand(CommandBase.builder()
