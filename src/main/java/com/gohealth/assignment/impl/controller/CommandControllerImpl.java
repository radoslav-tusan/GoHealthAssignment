...
public class CommandControllerImpl implements CommandController {
    ...
    public CommandControllerImpl(IssueService<CreateIssueDto, IssueDto, String> issueService, TableGenerator tableGenerator) {
    ...
    public Object processCommand(CommandBase cmd) throws Exception {
        switch (cmd.getOperation()) {
            case Commands.OPERATION.CREATE -> {
                ...
                return issueService.createIssue(CreateIssueDto.builder()
