...
@Service
@Transactional
public class IssueServiceImpl extends ServiceBase
    implements IssueService<CreateIssueDto, IssueDto, String> {

  private final Map<String, DataRepository<IssueEntity, String>> repositories;
  private final IssueMapper issueMapper;

  public IssueServiceImpl(
      Map<String, DataRepository<IssueEntity, String>> repositories, IssueMapper issueMapper) {
